...
public static class UnityPatches
{
	...
	{
		string patchDirectoryPath = fileSystem.Path.Join(exportDirectoryPath, "Assets", "Editor", "AssetRipperPatches");
		string patchFilePath = fileSystem.Path.Join(patchDirectoryPath, $"{name}.cs");
	...
	private static string MissingScriptsFinderText =>
		...
		namespace AbyssMoth
		{
		    public sealed class MissingScriptsFinder : EditorWindow
		    {
		        ...
		        [MenuItem("Tools/AssetRipper/Find Missing Scripts")]
