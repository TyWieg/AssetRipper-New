...
public sealed class UnloadedStructure : UnityAssetBase, IDeepCloneable
{
	...
	public SerializableStructure? LoadStructure()
	{
		...
		{
			EndianSpanReader reader = new(StructureData, MonoBehaviour.Collection.EndianType);
	...
	private static bool ShouldTraceManagedReferenceLayout(string? typeName)
	{
		...
		return typeName is "RequestableOwnershipGuard" or "TransferrableItemSlotTransformOverride" or "Player" or "VRRig";
	}
