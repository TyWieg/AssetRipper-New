...
public sealed class SerializableStructure : UnityAssetBase, IDeepCloneable
{
	...
	private static bool ShouldTraceManagedReferenceLayout(string typeName)
	{
		...
		return typeName is "RequestableOwnershipGuard" or "TransferrableItemSlotTransformOverride" or "SlotTransformOverride" or "NetworkProjectConfigAsset" or "Player" or "VRRig";
	}
